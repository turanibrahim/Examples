...
```
I cheated just a little bit because I couldn't imagine how I can sort data if I merge them one piece. I just looked up to algorithm structure after then write it myself with little bit cheat :P
```
